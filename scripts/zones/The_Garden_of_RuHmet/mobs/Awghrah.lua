...
function onMobSpawn(mob)
    ...
    if (skin == 1161) then -- Fire
        mob:setMod(tpz.mod.ICESDT, 27);
        mob:setMod(tpz.mod.WATERSDT, -27);
    elseif (skin == 1164) then --Earth
        mob:setMod(tpz.mod.THUNDERSDT, 27);
        mob:setMod(tpz.mod.WINDSDT, -27);
    elseif (skin == 1162) then -- Water
        mob:setMod(tpz.mod.THUNDERSDT, -27);
        mob:setMod(tpz.mod.FIRESDT, 27);
    elseif (skin == 1163) then -- Wind
        mob:setMod(tpz.mod.ICESDT, -27);
        mob:setMod(tpz.mod.EARTHSDT, 27);
    ...
    elseif (skin == 1167) then --Light
        mob:setMod(tpz.mod.LIGHTSDT, 27);
        mob:setMod(tpz.mod.DARKSDT, -27);
